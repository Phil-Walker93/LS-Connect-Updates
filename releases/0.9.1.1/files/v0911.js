/* LS Connect v0.9.1.1 – stabilized live bootloader r5 */
...
(async function v0911Boot(){
  ...
  for(const [version,file] of chain){
    ...
    await new Promise((resolve,reject)=>{
      ...
      script.src=`/api/script?version=${encodeURIComponent(version)}&file=${encodeURIComponent(file)}&v=0911-stable-repair-r5`;
      script.async=false;
  ...
  console.info('[LS Connect] v0.9.1.1 stabilized live boot r5 complete');

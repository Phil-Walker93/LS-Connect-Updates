...
// v0.7.7.3 must load before the startup gate is released.
(function v0773SyncLoader(){
  if (typeof LS_CONNECT_V0773_VERSION !== 'undefined') return;
  if (document.readyState === 'loading') {
    document.write('<script src="v0773.js"><\\/script>');
    return;
  }
  const script=document.createElement('script');script.src=`v0773.js?t=${Date.now()}`;document.head.appendChild(script);
})();

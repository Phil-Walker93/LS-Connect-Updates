/* LS Connect v0.7.10 hybrid compatibility loader */
(function(){
  ...
  (async()=>{
    try{
      await load('./v0775-core.js?v=0.7.10');
      await load('./v078.js?v=0.7.10');
      await load('./v0781.js?v=0.7.10');
      await load('./v079.js?v=0.7.10');
      await load('./v0791.js?v=0.7.10');
      await load('./v0795.js?v=0.7.10');
      await load('./v0710.js?v=0.7.10');
    }catch(error){console.error('[LS Connect] v0.7.10 Loaderfehler',error);}
  })();
})();
